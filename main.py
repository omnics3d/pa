        ...
        while True:
            ...
            if script_data := scripts.get(s_choice):
                ...
                if "scripts" in script_data and script_data["scripts"]:
                    ...
                    should_return_to_main = self._navigate_menu(
                        script_data, new_menu_path
                    )
                ...
                if module_path:
                    ...
                    print(
                        f" Пункт '{script_data.get('description', 'Unknown')}' не содержит исполняемого скрипта."
                    )
                    print(f"\033[{terminal_height - 1};0H", end="")
