...
class MenuManager:
    ...
    def setup_ui(self):
        ...
        other_act.triggered.connect(lambda: self.win.custom_tf_multiplier(1, "Minutes"))
        ...
        for t, m, u in [
            ...
            act.triggered.connect(
                lambda c=False, mm=m, uu=u: self.win.custom_tf_multiplier(mm, uu)
            )
        ...
        for ex in self.win.manager.get_exchange_names():
            ...
            for mk in self.win.manager.get_markets_for_exchange(ex) or []:
                ...
                for tl in self.win.manager.get_tools_for_market(ex, mk) or []:
                    ...
                    act.triggered.connect(
                        lambda chk=False, e=ex, m=mk, t=tl: self.win.on_tool_selected(
                            e, m, t
                        )
                    )
                    mk_m.addAction(act)
