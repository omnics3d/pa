...
try:
    ...
    from exchange_config_loader import (
        get_full_names_of_all_exchanges,
        get_full_names_of_all_markets,
        get_names_all_tools,
    )
...
class ExchangeMenu:
    ...
    def display_markets(self, exchange: str):
        ...
        menu_lines = [f"--- ВЫБОР РЫНКА (Биржа: {exchange}) ---"]
    ...
    def display_tools(self, exchange: str, market: str):
        ...
        menu_lines = [f"--- ВЫБОР ИНСТРУМЕНТА (Биржа: {exchange}, Рынок: {market}) ---"]
